...
function ContractorCombobox(props: {
  ...
  const { contractors, value, onChange, disabled, loading, placeholder } =
    props;
      ...
      <div style={{ display: "grid", gap: 6 }}>
        <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
          <input
            ...
            placeholder={
              placeholder ??
              "Szukaj kontrahenta (nazwa/NIP) lub zostaw puste = wszyscy"
            }
            onChange={(e) => {
...
export const LedgerList: React.FC = () => {
  ...
  const [kpirMode, setKpirMode] = useState<"month" | "quarter" | "year">(
    "month"
  );
  ...
  const [kpirQuarter, setKpirQuarter] = useState<number>(
